...
provision_debian_enhanced_impl() {
...
provision_debian_enhanced() {
    run_strict "provision_debian_enhanced" provision_debian_enhanced_impl "$@"
}

export -f provision_debian_enhanced_impl provision_debian_enhanced
