...
provision_alpine_enhanced_impl() {
...
provision_alpine_enhanced() {
    run_strict "provision_alpine_enhanced" provision_alpine_enhanced_impl "$@"
}

export -f provision_alpine_enhanced_impl provision_alpine_enhanced
